...
class GymMenuList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      customer: [],
                ...
                this.state.scheduleList.map((item, index) => (
                  <div className="col-md-4" key={index}>
                    <div className="gallery-demo">
                      <img src={item.gym_url} alt=" " className="img-fluid" />
                      <h4 className="p-mask">{item.schedule_name}</h4>

                      <h4 className="p-mask">
                        <span>{item.instructor_name}</span>
                      </h4>
                      <h4 className="p-mask">
                        Day :<span>{item.schedule_date}</span>
                      </h4>
                      <h4 className="p-mask">
                        Time :<span>{item.schedule_time}</span>
                      </h4>
                      <h4 className="p-mask">
                        Type :<span>{item.schedule_type}</span>
                      </h4>

                      <Link
                        to={`/book_gym_schedule/${item._id}`}

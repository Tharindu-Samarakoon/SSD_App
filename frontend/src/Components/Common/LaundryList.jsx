          ...
          <div className="container py-xl-5 py-lg-3">
            ...
            >
              <h3 className="w3ls-title mb-3">
                Our <span> Laundry Schedules</span>
              </h3>
            </div>
                ...
                this.state.laundryList.map((item, index) => (
                  <div className="col-md-4" key={index}>
                    <div className="gallery-demo">
                      ...
                      /> */}
                      <h4 className="p-mask">
                        ID : {item.laundry_schedule_id}
                      </h4>

                      <h4 className="p-mask">
                        <span>Schedule Name : {item.schedule_name}</span>
                      </h4>
                      <h4 className="p-mask">
                        <span>Schedule Type : {item.schedule_type}</span>
                      </h4>
                      <h4 className="p-mask">
                        <span> Schedule Weight : {item.schedule_weight}</span>
                      </h4>
                      <h4 className="p-mask">
                        <span>Schedule Price : {item.schedule_price}</span>
                      </h4>
                      <h4 className="p-mask">
                        <span>Deliver Date : {item.deliver_date}</span>
                      </h4>

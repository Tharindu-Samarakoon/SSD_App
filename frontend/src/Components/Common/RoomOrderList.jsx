...
class RoomOrderList extends Component {
  ...
  async componentDidMount() {
    ...
    await axios
      .get(
        `${APIURL}/room_order/get_all_room_order_details/${this.state.user_id}`
      )
      .then((response) => {
                    ...
                    {this.state.orderList.length > 0 &&
                      this.state.orderList.map((item, index) => (
                        <tr>
                          ...
                          >
                            <p className="text-current">{item.room_name}</p>
                          </td>
                          <td
                            data-label="Lead Score"
                            style={{ fontSize: 12, color: "black" }}
                          >
                            <p className="text-current">{item.room_price}</p>
                          </td>
                          <td
                            data-label="Lead Score"
                            style={{ fontSize: 12, color: "black" }}
                          >
                            <p className="text-current">{item.no_of_room}</p>
                          </td>
                          <td
                            data-label="Lead Score"
                            style={{ fontSize: 12, color: "black" }}
                          >
                            <p className="text-current">{item.person_count}</p>
                          </td>
                          <td
                            data-label="Lead Score"
                            style={{ fontSize: 12, color: "black" }}

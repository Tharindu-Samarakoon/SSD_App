...
class LiqourList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      customer: [],
                  ...
                  <div className="col-md-4" key={index}>
                    <div className="gallery-demo">
                      <img
                        ...
                        className="img-fluid"
                      />
                      <h4 className="p-mask">{item.liquor_id}</h4>
                      <h4 className="p-mask">
                        {item.liquor_type} : {item.liquor_name}
                      </h4>
                      <h4 className="p-mask">{item.liquor_qnty}</h4>
                      <h4 className="p-mask">{item.liquor_price}</h4>

                      <Link
                        to={`/get_liquor_customer/${item._id}`}

...
class EditFoodItem extends Component {
  ...
  async componentDidMount() {
    await axios
      ...
      .then((response) => {
        this.setState({ MenuItem: response.data.MenuItems });
        console.log("MenuItem =>", this.state.MenuItem);

        this.setState({ item_name: this.state.MenuItem.item_name });
        this.setState({ item_type: this.state.MenuItem.item_type });
        this.setState({ item_time: this.state.MenuItem.item_time });
        this.setState({
          item_price_type_small: this.state.MenuItem.item_price_type_small,
        });
        this.setState({
          item_price_type_medium: this.state.MenuItem.item_price_type_medium,
        });
        this.setState({
          item_price_type_large: this.state.MenuItem.item_price_type_large,
        });
        this.setState({
          image: this.state.MenuItem.item_url,
        });
      });
  }
  ...
  onSubmit(event) {
    ...
    axios
      .put(
        `${APIURL}/menulist/update-menu-item/${this.props.match.params.id}`,
        formData
      )
      .then((res) => {
        console.log("res", res);
  ...
  onDelete(event) {
    ...
    axios
      .delete(
        `${APIURL}/menulist/delete-menu-item/${this.props.match.params.id}`
      )
      .then((res) => {
        console.log("res", res);
        if (res.data.code === 200) {
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            <div id="content">
              <nav className="navbar navbar-expand topbar mb-4 static-top">
                <h1 className="h3 mb-2 text-gray-800">Newly Food Record Add</h1>
                            ...
                            <div className="col-lg-6">
                              <div className="p-5">
                                <div className="text-center">
                                  ...
                                  >
                                    Edit {this.state.item_name}'s Details
                                  </h1>
                                </div>
                                <form
                                  className="user"

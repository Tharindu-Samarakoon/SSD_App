...
class AddLaundrySchedule extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit(event) {
    ...
    console.log("object", LaundryDetails);
    axios
      .post(`${APIURL}/laundry/add-laundry-schedule-details`, LaundryDetails)
      .then((res) => {
        console.log("res", res);
            ...
            <div id="content">
              <nav className="navbar navbar-expand topbar mb-4 static-top">
                <h1 className="h3 mb-2 text-gray-800">
                  Newly Laundry Schedule Record Add
                </h1>
...
export default AddLaundrySchedule;

...
const CheckRoomOrderStatus = () => {
    ...
    async function gedData() {
      try {
        const response = await axios.get(
          `${APIURL}/room_order/get_all_room_order_details`
        );
  ...
  const downloadReport = () => {
    doc.text("Room Booking Status Report", 30, 10);
    ...
    order.map((orders, index) => {
      ...
      row.push(orders._id);
      row.push(orders.room_name);
      row.push(orders.room_price);
      row.push(orders.no_of_room);
    ...
    if (!inp.target.value) {
      ...
      let searchList = baseData.filter(
        (data) =>
          ...
          data.room_name.toLowerCase().includes(inp.target.value.toLowerCase())
      );
      SetOrder(searchList);
    }
  };
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          ...
          <div id="content">
            ...
            <nav className="navbar navbar-expand topbar mb-4 static-top">
              <h1 className="h3 mb-2 text-gray-800">All Room Booking List</h1>
            ...
            <div className="container-fluid">
              <p className="mb-4">All Room Booking List available in here.</p>
...
export default CheckRoomOrderStatus;

...
class GetRoomsOrderList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      initialState,
  ...
  async componentDidMount() {
    await axios
      .get(`${APIURL}/room_order/get_all_room_order_details`)
      .then((response) => {
  ...
  onApprove(e, id) {
    ...
    console.log(id);
    axios
      .put(`${APIURL}/room_order/give_approve/${id}`, updateDetailsStatus)
      .then((res) => {
        console.log(res.data);
        if (res.data.code === 200) {
          toast.success(res.data.message);
          this.props.history.push("/check_all_room_order_status");
        } else {
...
export default GetRoomsOrderList;

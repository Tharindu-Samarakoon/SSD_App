...
class GetAllRoomDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      roomsList: [],
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
              ...
              <nav className="navbar navbar-expand topbar mb-4 static-top">
                <h1 className="h3 mb-2 text-gray-800">All Rooms List</h1>
              ...
              <div className="container-fluid">
                <p className="mb-4">All Room Details available in here.</p>
                <Link to="/get-all-rooms-details">
                          ...
                          this.state.roomsList.map((item, index) => (
                            <tbody key={index}>
                              <tr>
                                ...
                                <td>{item.room_meals}</td>
                                <td>{item.room_price}</td>
                                <td>
                                  <Link to={`/edit-rooms-details/${item._id}`}>
...
export default GetAllRoomDetails;

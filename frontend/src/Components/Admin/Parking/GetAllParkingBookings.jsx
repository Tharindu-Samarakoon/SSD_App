...
class GetAllParkingBookings extends Component {
  constructor(props) {
    super(props);
    this.state = {
      bookList: [],
  ...
  async componentDidMount() {
    await axios
      .get(`${APIURL}/park_order/get_all_park_order_details`)
      .then((response) => {
        this.setState({ bookList: response.data.AllOrderDetails });
  ...
  onApprove(e, id) {
    ...
    console.log(id);
    axios
      .put(`${APIURL}/park_order/give_approve/${id}`, updateDetailsStatus)
      .then((res) => {
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
              ...
              <div className="container-fluid">
                <p className="mb-4">
                  All Booking Parking List available in here.
                </p>
...
export default GetAllParkingBookings;
